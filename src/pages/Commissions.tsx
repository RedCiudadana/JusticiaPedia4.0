                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
                            <div className="flex-1 min-w-0">
                              ...
                              <h3 className="text-xl md:text-2xl font-bold text-neutral-900 mb-2 hover:text-primary-700 transition-colors">
                                {commission.name}
                              </h3>
                              {commission.description && !isExpanded && (
                                <p className="text-neutral-600 text-sm line-clamp-2 mb-4">{commission.description}</p>
                              )}
                            </div>
                          </div>
